...
export default function Mobile() {
  const [flip, setFlop] = useState(false);
  return (
    <>
      {flip && (
        <nav className="fixed flex bg-black/50 w-full z-40  h-full">
          <div
            className="flex flex-col items-center w-full"
            style={StyleWeb.DesktopStyle.bgNavy900}
          >
            <header className="flex items-center justify-around py-4 w-[500px]">
              <img
                width={140}
                height={45}
                src={"/images/logo.svg"}
              ...
              <button
                ...
                onClick={() => setFlop(!flip)}
              >
                {flip ? <BiX size={40} /> : ""}
              </button>
            </header>
            <Link
              className="hover:border-b-2 hover:opacity-100 opacity-75 text-2xl w-2/3 py-2 px-2 hover:bg-black/25"
              href={"#"}
            >
              Feature
            </Link>
      ...
      <Header className="flex gap-4">
        <button className="z-40 cursor-pointer" onClick={() => setFlop(!flip)}>
          {!flip ? <BiMenu size={40} /> : ""}
        </button>
      </Header>
      <Hero>
      ...
      <section style={StyleWeb.DesktopStyle.bgNavy900}>
        <List._ className="flex flex-col">
      ...
      <section
        ...
        style={StyleWeb.DesktopStyle.bgNavy900}
      >
        <List._ className="flex flex-col gap-8 w-4/5">
          <List.Item>
            <img
              width={1200}
      ...
      <section style={StyleWeb.DesktopStyle.bgNavy900}>
        <div className="flex justify-center relative py-28">
          <List._ className="flex flex-col gap-8 relative justify-between">
            <List.Item
              className="w-sm p-4 rounded-2xl z-10"
              style={StyleWeb.DesktopStyle.bgNavy800}
            >
              <img
                className="hidden -left-4 -top-4"
      ...
      >
        <div
          className="flex flex-col gap-2 relative -top-15 w-2/3 p-5 rounded-xl  sombra"
          style={StyleWeb.DesktopStyle.bgNavy900}
        >
      ...
      <footer className="flex flex-col items-center pt-20 pb-10">
        ...
        <nav className="flex flex-col gap-4 py-5 justify-around w-4/5">
          <div>
